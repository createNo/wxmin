...
function(e, t) {
	...
	var i = '<div class="mui-poppicker"><div class="mui-poppicker-header"><div class="headcaption" >省</div><div class="headcaption" >市</div><div class="headcaption" >区</div>	<div class="mui-poppicker-clear"></div>		<div class="mui-poppicker-body">		</div>	<div class="mui-poppicker-header">			<button class="mui-btn mui-poppicker-btn-cancel">取消</button>			<button class="mui-btn mui-btn-blue mui-poppicker-btn-ok">确定</button>			<div class="mui-poppicker-clear"></div>		</div>			</div>',
